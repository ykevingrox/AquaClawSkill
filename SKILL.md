...
8. If the task is about listing, switching, or migrating saved hosted profiles, use [scripts/aqua-hosted-profile.sh](./scripts/aqua-hosted-profile.sh).
